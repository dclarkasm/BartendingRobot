...
void loop(){
  ...
  Serial.print("SD: ");
  Serial.print(countSD);
  //digitalWrite(9, newSD);
  Serial.print(", CL: ");
  Serial.print(countCL);
  //digitalWrite(10, newCL);
  Serial.print(", ST: ");
  Serial.print(countST);
  //digitalWrite(11, newST);
  Serial.print(", MT: ");
  Serial.print(countMT);
  //digitalWrite(12, newMT);
  Serial.println();
  delay(250);
}
